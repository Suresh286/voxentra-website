...
function AboutPage({ content }: AboutPageProps) {
  return (
    <>
      ...
      <NarrativeSection id="story" content={content.story} background="surface" />
      <NarrativeSection id="mission" content={content.mission} />
      <NarrativeSection id="vision" content={content.vision} background="surface" />
      <FeatureGridSection
        id="principles"
        content={{ ...content.principles, items: content.principles.items }}
        columns={2}
      />
      <NarrativeSection id="why-exists" content={content.whyExists} background="surface" />
